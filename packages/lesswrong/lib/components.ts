...
importComponent("SequencesTooltip", () => require('../components/sequences/SequencesTooltip'));
importComponent("SequencesSummary", () => require('../components/sequences/SequencesSummary'));
importComponent("CollectionsTooltip", () => require('../components/collections/CollectionsTooltip'));
...
importComponent(["FormUserMultiselect","UserMultiselect"], () => require('../components/form-components/UserMultiselect'));
importComponent(["FormUserSelect","UserSelect"], () => require('../components/form-components/UserSelect'));
